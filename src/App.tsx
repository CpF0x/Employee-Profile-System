      ...
      <header>
        <div className="container header-content">
          ...
          <ul className="nav-links">
            ...
            <li className="nav-item">
              <span className="icon">📋</span>
              <a href="professional-timeline.html" className="timeline-link">Experience</a>
            </li>
            <li className="nav-item">
        ...
        <div className="content-column">
          ...
          <div className="card">
            <div style={{ padding: '25px', textAlign: 'center' }}>
              ...
              <a href="professional-timeline.html" style={{ display: 'inline-block', textDecoration: 'none' }} id="timelineLink" className="timeline-link">
                <button className="btn btn-primary">
                  <span>📋</span> 查看完整经验时间线
                </button>
              </a>
