  ...
  return (
    <div className={styles.socialLoginContainer}>
      <div className={styles.divider}>
        <span className={styles.dividerText}>或使用以下方式登录</span>
      </div>
      <div className={styles.socialButtons}>
        ...
        >
          <svg className={styles.icon} aria-hidden="true" focusable="false" data-prefix="fab" data-icon="google" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 488 512">
        ...
        >
          <svg className={styles.icon} aria-hidden="true" focusable="false" data-prefix="fab" data-icon="github" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
